...
public class ExportCert {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String keystoreFile = "D:\\program_files\\codespace-study\\cloud-config-repo\\w-jks\\csii.jks";//私钥地址
        String password = "phoenix"; //keystore的解析密码
        String friendPassword = "phoenix";//条目的解析密码

        KeyStore keyStore = KeyStore.getInstance(keyStoreType);
        keyStore.load(new FileInputStream(keystoreFile), password.toCharArray());

        String alias = "csii_key";//条目别名
        String exportCertFile = "D:\\program_files\\codespace-study\\cloud-config-repo\\w-jks\\cert.txt";
        String exportPrivateFile = "D:\\program_files\\codespace-study\\cloud-config-repo\\w-jks\\privateKey.txt";
        String exportPublicFile = "D:\\program_files\\codespace-study\\cloud-config-repo\\w-jks\\publicKey.txt";
